import styles from "./StaysInformation.module.scss";
...
function StaysInformation({date,setDate,addGuest,setAddGuest,number,setNumber}) {
    ...
    return (
        <ul className={styles.informations}>
            <li className={styles.information} onClick={clickHandler}>
                <h5>Where</h5>
                <h4>{content}</h4>
            </li>
            <li className={styles.information} onClick={dateHandler}>
                <h5>Check in</h5>
                <h4>{date}</h4>
            </li>
            <li className={styles.information} onClick={addGuests}>
                <h5>Who</h5>
            ...
            {isClicked && <Map/>}
            {dateIsCLicked && <Calender setDate={setDate}/>}
            {addGuest &&  <AddGuest number={number} setNumber={setNumber}/>}
        </ul>
    )
}

export default StaysInformation